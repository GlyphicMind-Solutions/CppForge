# /CppForge/engine/deep_analysis.py
# CppForge Deep Analysis Engine
...
class DeepAnalysisEngine:
    """
    Deep Analysis Engine v2 for CppForge
...
# =============================== #
    ...
    def summarize_chunk(self, chunk: str, index: int, total: int) -> str:
        topic = (
            ...
            "Focus on headers, source files, namespaces, classes, structs, templates, functions, "
            "logic flow, and relationships:\n\n"
            f"{chunk}"
        )
    ...
    def merge_summaries(self, summaries: List[str]) -> str:
        ...
        topic = (
            ...
            "Describe headers, source files, namespaces, classes, structs, templates, "
            "functions, dependencies, and architecture:\n\n"
            f"{joined}"
        )
    ...
    def analyze_from_summary(self, meta_summary: str) -> str:
        topic = (
            ...
            "Preserve logic, improve structure, respect header/source separation when appropriate, "
            "and output ONLY C++ code (including all necessary files if implied):\n\n"
            f"{meta_summary}"
        )
