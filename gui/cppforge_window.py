# /CppForge/gui/cppforge_window.py
# CppForge GUI Window (Tabbed IDE Layout)
...
# =======================================
# CPP FORGE WINDOW CLASS
# =======================================
class CppForgeWindow(QMainWindow):
    """
    CppForge GUI (Tabbed IDE Layout)
    ...
    def __init__(self, llm_engine, storage_root: Path, parent=None):
        ...
        self.setWindowTitle("CppForge — C++ Code Forge")
...
# ==================================================================
    ...
    def _on_generate_clicked(self):
        ...
        if not topic:
            QMessageBox.warning(self, "CppForge", "Please enter a forge topic.")
            return
    ...
    def _on_rerun_clicked(self):
        ...
        if not topic and not self._last_topic:
            QMessageBox.warning(self, "CppForge", "No topic available.")
            return
    ...
    def _on_approve_clicked(self):
        ...
        if not code:
            QMessageBox.warning(self, "CppForge", "No code in Master Code.")
            return
    ...
    def _on_save_clicked(self):
        ...
        if not code.strip():
            QMessageBox.warning(self, "CppForge", "No code to save.")
            return
    ...
    def _on_open_clicked(self):
        ...
        try:
            ...
            QMessageBox.critical(self, "CppForge", f"Failed to open file: {e}")
            return
    ...
    def _on_deep_analysis_clicked(self):
        code = self.master_code_edit.toPlainText().strip()
        if not code:
            QMessageBox.warning(self, "CppForge", "No code to analyze.")
            return
        ...
        if not corrected or not corrected.strip():
            QMessageBox.warning(self, "CppForge", "Deep Analysis produced no corrected code.")
            return
    ...
    def _run_forge(self, topic: str, use_feedback: bool):
        ...
        if not code:
            ...
            QMessageBox.warning(self, "CppForge", "No valid C++ code found.")
            return
...
# ================================================================
    ...
    def _extract_code(self, raw: str):
        ...
        match = re.search(
            r"^(#include |namespace |class |struct |template|int main\s*\()",
            raw,
            flags=re.MULTILINE,
        )
